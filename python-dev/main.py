# frontEnd -> "é o que se vê"
    #html, css, javascript
#backend -> a logica de funcionamento por tras do site
    #python
# framework -> flask -> crir site 
# ambiente virtual -> local no seu computador com instalações especificas
...
if __name__ == "__main__":
    socketio.run(app, host='192.168.1.76') 
