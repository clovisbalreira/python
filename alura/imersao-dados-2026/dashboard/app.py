...
#Ideia 2 - Streamlit direto no colab
# O LocalTunnel é uma ferramenta que cria um link público seguro para um serviço rodando localmente,
# permitindo acessar aplicações em localhost pela internet.